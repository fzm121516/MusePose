...
def parse_args():
    ...
    parser.add_argument("--save_dir", type=str, default="./output", help="Directory to save output videos")
...
def main():
    ...
    def handle_single(ref_image_path, pose_video_path):
        ...
        repeat_frame_num = (args.S - args.O - last_segment_frame_num) % (args.S - args.O)
        for i in range(repeat_frame_num):
